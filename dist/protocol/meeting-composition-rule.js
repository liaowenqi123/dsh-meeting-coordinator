...
export const briefingBoardCompositionRule = {
    ...
    preflight(input) {
        ...
        for (const requirement of input.requirements) {
            ...
            const requestedDomain = typeof rawSpec === 'object' && rawSpec !== null && !Array.isArray(rawSpec)
                ? rawSpec.boardDomain
                : undefined;
            if (requestedDomain === undefined) {
                const domains = new Set(candidates
                    .map((candidate) => candidate.support.spec?.boardDomain)
                ...
                if (domains.size > 1) {
                    issues.push({
                        ...
                        message: `消费方未指定 boardDomain，但候选 coordinator 分属 ${domains.size} 块板 ` +
...
//# sourceMappingURL=meeting-composition-rule.js.map