...
export class RoomMinutesCorrupted extends Error {
    code = 'meeting/room-minutes-corrupted';
    constructor(message) {
        super(message);
...
export class RoomMinutesLog {
     ...
     */
    appendTurn(roomId, meetingId, turn) {
        if (!existsSync(this.liveDir))
            mkdirSync(this.liveDir, { recursive: true });
...
//# sourceMappingURL=room-minutes.js.map