...
export class BriefingBudgetExceeded extends Error {
    code = 'meeting/briefing-budget-exceeded';
    limit;
    actual;
 ...
 */
export function briefingCharCount(draft) {
...
export function assertWithinBudget(draft, maxChars) {
...
/** 校验必填字段非空。 */
export function assertDraftWellFormed(draft) {
 ...
 */
export function briefingFingerprint(draft) {
    const parts = [
...
//# sourceMappingURL=briefing-text.js.map