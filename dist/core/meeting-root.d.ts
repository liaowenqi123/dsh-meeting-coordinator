...
export declare const MEETING_ROOT_DIRNAME = "meeting-coordinator";
/** 覆盖数据根的环境变量。 */
export declare const MEETING_ROOT_ENV = "DSH_MEETING_ROOT";
/** 覆盖板标识的环境变量。 */
export declare const MEETING_BOARD_ENV = "DSH_MEETING_BOARD";
/**
 ...
 */
export declare function defaultMeetingRootDir(env?: Record<string, string | undefined>): string;
/**
 ...
 */
export declare function resolveMeetingRootDir(configRootDir?: string | undefined, env?: Record<string, string | undefined>): string;
/** 板标识：`config > env > 'default'`。板标识与数据根是两件事，别混在一个解析器里。 */
export declare function resolveMeetingBoardDomain(configBoardDomain?: string | undefined, env?: Record<string, string | undefined>): string;
//# sourceMappingURL=meeting-root.d.ts.map