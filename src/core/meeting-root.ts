 ...
 */
export function defaultMeetingRootDir(env: Record<string, string | undefined> = process.env): string {
 ...
 */
export function resolveMeetingRootDir(
...
export function resolveMeetingBoardDomain(
  configBoardDomain?: string | undefined,
  env: Record<string, string | undefined> = process.env,
): string {
